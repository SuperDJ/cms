...
<form action="" method="post" onsubmit="encrypt()">
	...
	<div class="row">
		...
		<button class="button"><?php echo $language->translate('Register'); ?> <i class="fa fa-cloud-upload"></i></button>
		<a href="?path=users/login" class="button"><?php echo $language->translate('Login'); ?> <i class="fa fa-sign-in"></i></a>
	</div>
</form>
